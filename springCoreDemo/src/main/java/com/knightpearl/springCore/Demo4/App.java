package com.knightpearl.springCore.Demo4;
...
public class App 
{
    ...
    {
       ClassPathXmlApplicationContext context=new ClassPathXmlApplicationContext("/com/knightpearl/springCore/Demo4/applicationContext.xml");
